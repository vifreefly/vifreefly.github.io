var hostname = "https://vifreefly.github.io";
...
var store = [{
    "title": "Puppeteer Stealth Page Fetcher Info",
    "link": "/tech/puppeteer-stealth-page-fetcher-info",
    "image": null,
    "date": "April 21, 2020",
    "category": ["tech"],
    "excerpt": "During the web scraping using Selenium or Headless Chrome, some websites can recognize that they are visited by an automated..."
},{
    "title": "First thing to do after creating a new VPS server: setup deploy user and enable SSH-key authentication only",
    "link": "/tech/first-thing-to-do-after-creating-a-new-vps-server",
    "image": null,
    "date": "February 22, 2019",
    "category": ["tech"],
    "excerpt": "0) If after creating a VPS server you received a root user password, it’s recommended to change it. To do..."
},{
    "title": "Did you know that you can use Bundler without Gemfile?",
